        ...
        >
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4 ">
              Nous avons développé cette application pour optimiser et moderniser
              le processus d'accompagnement Prépa Compétences.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4"> 
              ...
              <ul className="list-disc pl-6 space-y-4 text-gray-600 dark:text-gray-300">
                ...
                <li>Faciliter la communication entre les participants et les formateurs.</li>
                <li>Genérer des rapports détaillés pour France Travail.</li>
              </ul>
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4 w-[80%]"> 
              Cette solution numérique vise à
              améliorer l'efficacité du programme, offrir une expérience
              personnalisée aux participants, et fournir des données précieuses
              pour l'évaluation continue et l'amélioration du dispositif.
            </p>
          </section>
        </TabsContent>
      </Tabs>
