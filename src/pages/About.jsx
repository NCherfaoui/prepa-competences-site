    ...
    <div className='container mx-auto px-4 py-12'>
      ...
      <section className='mb-12'>
        ...
        <ul className='list-disc pl-6 space-y-4 text-gray-600 dark:text-gray-300'>
          <li>
            Centraliser et organiser l'ensemble des informations relatives aux
            parcours des candidats, aux ateliers, aux évaluations et aux bilans
            de compétences.
          </li>
          <li>
            Faciliter la communication et la collaboration entre les candidats,
            les formateurs et les conseillers France Travail.
          </li>
          <li>
            Automatiser la génération et la transmission des documents, tels que
            les formulaires d'adhésion et les bilans de sortie.
          </li>
          <li>
            Améliorer le suivi et l'évaluation des progrès des candidats tout au
      ...
      <section className='mb-12'>
        ...
        <ul className='list-disc pl-6 space-y-4 text-gray-600 dark:text-gray-300'>
          <li>
            Sécuriser le projet professionnel des participants en les aidant à
            confirmer leur projet et à définir le parcours de formation adapté.
          </li>
          <li>
      ...
      <section>
        ...
        <ul className='list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300'>
          ...
          <li>
            Publics prioritaires du Plan d'investissement dans les compétences
            (PIC)
          </li>
        </ul>
      </section>
