  ...
  return (
    <animated.div style={modalAnimation} className="fixed inset-0 bg-black bg-opacity-80 bg-blur backdrop-blur backdrop-saturate-150 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
        ...
        <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Diagramme de pensée Prépa Compétences</h2>
        <iframe className=''
          width="100%"
          height="500"
        ...
        >
          Your browser does not support frames. <a href="https://www.mindomo.com/mindmap/prpa-comptences-06ef443acd6647dd9f82229149ddb1f7" target="_blank">View</a> this map on its original site. It was created using <a href="https://www.mindomo.com" target="_blank">Mindomo</a>.
        </iframe>
      </div>
    </animated.div>
  );
