...
const InteractiveDiscoveryModal = ({ isOpen, onClose }) => {
  ...
  const sections = [
    ...
    },
    {
      title: 'Quand ?',
      content:
        "Nouveau groupe tous les lundis, avec une flexibilité accrue pour s'adapter aux besoins individuels"
    },
    {
      title: 'Financement',
      content:
        'Pris en charge par France Travail, avec possibilité de rémunération pendant la formation (AREF ou R2F)'
    },
    {
      title: 'Résultats',
      content:
        "Taux d'accès à l'emploi de 63,2% dans les 6 mois suivant la fin de la formation (au 4e trimestre 2023)"
    }
  ]
