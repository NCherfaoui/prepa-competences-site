...
const InteractiveDiscovery = () => {
  return (
    <div className="container mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Découvrez Prépa Compétences</h2>
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              <li>Faciliter la réussite des formations des demandeurs d'emploi</li>
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent>
            <ul className="list-disc pl-6 space-y-2 text-gray-600">
              <li>PHASE 1: accueil + co-construction du parcours de renforcement</li>
              <li>PHASE 2: stage en entreprise (PMSMP)</li>
              <li>PHASE 3: Ateliers de renforcement compétences de base</li>
              <li>PHASE 4 : co-construction du parcours de formation individualisé / BILAN FINAL</li>
            </ul>
          </AccordionContent>
        </AccordionItem>
